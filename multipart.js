...
* Takes a buffer and a boundary
* and returns a associative array of
* key/value pairs; if content is a file,
* value will be an object with properties
...
*Parses a content selection and returns the
*key/value pair as a two-element array
**/
